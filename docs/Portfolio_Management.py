...
def app():
	...
	with create_tab:
		...
		with visualisation_col:
			visualisation_list = ["Asset Distribution - Tree Map", "Profit and Loss - Bar Chart with Heat Map", "Networth Over Time - Line Chart"]
			...
			elif select_visualisation == "Portfolio Value - Line Chart":
				line_chart_portfolio_value()
