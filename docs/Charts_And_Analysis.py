...
def app():
    ...
    with cumulative_returns_col:
        ...
        with spx500_tab:
            ...
            with spx500_asset_dropdown:
                spx500_tickers = si.tickers_sp500()
                spx500_dropdown_input = st.multiselect('Ticker Symbol', spx500_tickers, default = ["ED", "FLT"])
    ...
    with live_price_and_overview_col:
        ...
        elif visualisation_selection == "Sun Burst":
            # --- Sun Burst Chart ---
        ...
        elif visualisation_selection == "Line Chart":
